---
title: "기술 블로그 구축  `🛠️ 기능 개발` 배포 중 깃 복구 과정"
slug: 기술-블로그-구축-기능-개발-배포-중-깃-복구-과정
date: "2025-04-10"
category: 개인
tags: ["Git", "CI/CD", "트러블슈팅"]
summary: "GitHub Actions가 저장소 파일을 지운 뒤 git pull로 로컬까지 날아간 상황을, 마지막 정상 커밋에서 recovery 브랜치를 따고 develop을 reset --hard로 되돌려 복구한 기록."
featured: false
---
