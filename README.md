...
|No|실습 자료|주요 실습 키워드|
|-|-|-|
|1|[예약-대기열-시스템](./핵사고날-패키지구조/예약-대기열-시스템)|`핵사고날` `레디스` `Sorted Set`|
|2|[사용자-활동-알림-시스템](./핵사고날-패키지구조/사용자-활동-알림-시스템)|`핵사고날` `RabbitMQ` `MSA`|
|3|[API-통합-시스템](./핵사고날-패키지구조/API-통합-시스템/)|`핵사고날` `MongoDB` `레디스 (캐시)` `Scheduler`|
|4|[업무-성과-관리-시스템](./업무지원-시스템/업무-성과-관리-시스템/)|`업무지원 시스템` `JSP` `MySQL` `Datatables`|
