---
title: "「29CM」 트랜잭셔널 아웃박스 패턴의 실제 구현 사례"
slug: 29cm-트랜잭셔널-아웃박스-패턴의-실제-구현-사례
date: "2024-10-25"
category: 기업-기술-블로그-탐구-일지
tags: ["트랜잭션", "Kafka", "Spring Boot", "아키텍처"]
summary: "비즈니스 로직 중간에 에러가 나면 이벤트가 유실되는 문제를 29CM가 아웃박스 테이블과 TransactionalEventListener의 BEFORE_COMMIT/AFTER_COMMIT 분리로 푼 방식을 따라가며 정리한 탐구 기록."
featured: false
---
