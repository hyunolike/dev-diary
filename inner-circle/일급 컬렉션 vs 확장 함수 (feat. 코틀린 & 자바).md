---
title: "일급 컬렉션 vs 확장 함수 (feat. 코틀린 & 자바)"
slug: 일급-컬렉션-vs-확장-함수-feat-코틀린-자바
date: "2024-09-30"
category: inner-circle
tags: ["Kotlin", "Java"]
summary: "컬렉션에 비즈니스 규칙을 붙일 때 자바처럼 일급 컬렉션으로 감쌀지 코틀린 확장 함수로 열어둘지를 코드로 비교하고, 어느 쪽이 레이어 구조에 더 잘 얹히는지 따져봤다."
featured: false
---
