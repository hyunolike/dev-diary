---
title: "DB와의 상호작용이 필요한 테스트코드는 어떻게 작성할까"
slug: db와의-상호작용이-필요한-테스트코드는-어떻게-작성할까
date: "2024-09-12"
category: inner-circle
tags: ["테스트", "JPA", "Kotlin"]
summary: "주문 생성 API가 재고와 배송 상태를 제대로 바꿨는지 검증하려고, Database Rider로 인메모리 DB에 데이터셋을 심고 기대 데이터셋과 비교하는 방식으로 통합 테스트를 짠 기록."
featured: false
---
