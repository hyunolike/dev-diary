---
title: "주문 서버 개발기 1편 (도메인)"
slug: 주문-서버-개발기-1편-도메인
date: "2024-09-11"
category: inner-circle
tags: ["DDD", "아키텍처", "트랜잭션"]
series: order-server
seriesOrder: 1
summary: "교보문고·예스24 같은 주문 서버를 맡아 코드를 짜기 전에, 회원·주문·상품·장바구니·결제·배송 여섯 도메인의 관계와 주문 프로세스의 트랜잭션·자동복구·성능 지점을 먼저 그려본 기록."
featured: false
---
## 주문 서버 개발기 1편 (도메인)
> 작성날짜: 24.09.11
